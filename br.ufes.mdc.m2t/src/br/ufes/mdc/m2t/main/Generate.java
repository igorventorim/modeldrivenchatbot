...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/br/ufes/mdc/m2t/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(br.ufes.inf.mdc.mdc.MdcPackage.class)) {
            resourceSet.getPackageRegistry().put(br.ufes.inf.mdc.mdc.MdcPackage.eINSTANCE.getNsURI(), br.ufes.inf.mdc.mdc.MdcPackage.eINSTANCE);
        }
